...
import { WebsiteContext } from '@/app/investors/[investorsId]/WebsiteProvider';
...
export function PagesTableIn({ allowFilter, ...props }: PagesTableProps) {
  const {
    router,
    renderUrl,
    query: { view = 'url' },
